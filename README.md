...
// array of stages of hangman
var bodyArray = [start, head, leftArm, rightArm, leftLeg , rightLeg]
// random word generator
var rand = Int.random(in: 0...742)
var chosenWord = allTheWords.randomElement()
// word place holders
var theWord = [Character]()
var placeHolder = [Character]()
// for wrong word counter
var wrongWord = 0
//keeps game going until it's false
...
// makes array of _ same size as chose word
for i in chosenWord! {
...
print(bodyArray[wrongWord])
print(placeHolder)
let letter = getInput()

for (key,value) in theWord.enumerated(){
if value == Character((letter)!){
placeHolder[key] = value
}
}

if !theWord.contains(Character(letter!)){
wrongWord += 1
print("Wrong letter")
}
}
...
gameLoop()
if wrongWord >= 6{
print("The word was: \(chosenWord ?? "no word was chose")")
print("GAME OVER")
gameIsNotOver = false
}
}
